...
for n in range(15):
    for m in range(15):
        for l in range(15):
            term13_ += xx_[0,n] * xx_[n,m] * xx_[m,l] * xx_[l,0] / (E_[n] - w1) / (E_[m] + w3 + w2) / (E_[l] + w3)
            
assert term13 == term13_, "--term13--"
...
for n in range(15):
    for m in range(15):
        for l in range(15):
            term14_ += xx_[0,n] * xx_[n,m] * xx_[m,l] * xx_[l,0] / (E_[n] + w1 + w2 + w3) / (E_[m] + w1 + w2) / (E_[l] + w2)
            
assert term14 == term14_, "--term14--"
